...
namespace EmberEngine
{
	...
	void MathF_SSE::Vector3CrossImpl(float* dst, float* vec1, float* vec2)
	{
	...
	void MathF_SSE::Vector3CrossImpl(double* dst, double* vec1, double* vec2)
	{
	...
	void MathF_SSE::MultiplyMatrix4x4Impl(float* dst, float* matrix1, float* matrix2)
	{
