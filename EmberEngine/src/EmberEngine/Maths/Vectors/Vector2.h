...
namespace EmberEngine
{
	...
	private:
		float z, w;
	public:
		Vector2f() { z = 0.0f; w = 0.0f; }
		Vector2f(float xf, float yf) : x(xf), y(yf), z(0.0f), w(0.0f) {}
	...
	public:
		Vector2d() {}
		Vector2d(double xd, double yd) : x(xd), y(yd) {}
	...
	public:
		Vector2i() { z = 0; w = 0; }
		Vector2i(int xi, int yi) : x(xi), y(yi), z(0), w(0) {}
